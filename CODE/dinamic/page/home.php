...
<div class="content1">
    ...
    <div class="form1">
        ...
        <input type="text" id="age" placeholder="Umur"><br>

        <select name="gender" id="gender" placeholder="Jenis Kelamin">
        <option value="male">Laki-laki</option>
        <option value="female">Perempuan</option></select><br>
    
        <label for="age">Kamar Tidur</label><br>
        <input type="number" id="kt" placeholder="Kamar Tidur"><br>

        <label for="age">Kamar Mandi</label><br>
        <input type="number" id="km" placeholder="Kamar Mandi"><br>

        <label for="age">Lantai</label><br>
        <input type="number" id="floor" placeholder="Lantai"><br>

        <label for="age">Luas Bangunan</label><br>
        <input type="number" id="lb" placeholder="Luas Bangunan"><br>

        <label for="age">Luas Tanah</label><br>
        <input type="number" id="lt" placeholder="Luas Tanah"><br>

        <label for="age">Beserta Furniture?</label><br>
        <select name="furniture" id="furniture" placeholder="Beserta Furniture?">
        <option value="yes">Yes</option>
        <option value="no">No</option></select><br> 

        <form method="post" action="result.php">
        <button type="submit" name="submit1">Search
        </button>
